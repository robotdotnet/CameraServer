...
function Build {
  ...
  exec { & dotnet build src\FRC.CameraServer $configuration $revision }
...
function Pack { 
  ...
  exec { & dotnet pack src\FRC.CameraServer $configuration $revision --no-build -o .\artifacts }
...
Copy-Item src\FRC.CameraServer\project.json buildTemp\FRC.CameraServer.projectjson

$netTablesJson = Get-Content 'src\FRC.CameraServer\project.json' -raw | ConvertFrom-Json
$netTablesJson.version = $version + "-*"
$netTablesJson | ConvertTo-Json -Depth 5 | Set-Content 'src\FRC.CameraServer\project.json'
...
Copy-Item buildTemp\FRC.CameraServer.projectjson src\FRC.CameraServer\project.json

Remove-Item buildTemp\FRC.CameraServer.projectjson